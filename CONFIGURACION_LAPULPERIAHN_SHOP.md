...
**Solución:**
1. Agregar `https://domain-explorer-2.preview.emergentagent.com` a orígenes
2. Agregar `https://domain-explorer-2.preview.emergentagent.com/auth/callback` a redirects
