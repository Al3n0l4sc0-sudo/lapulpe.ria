...
**Solución:**
1. Agregar `https://galactic-lapulpe.preview.emergentagent.com` a orígenes
2. Agregar `https://galactic-lapulpe.preview.emergentagent.com/auth/callback` a redirects
